...
if (in_array($acao, $acoesRestritas) && $_SESSION['usuario_papel'] !== 'Administrador') {
    ...
    // Corrigido caminho para acesso negado, assumindo que ele esteja em /app/views/
...
switch ($acao) {
    ...
    case 'salvar':
        ...
        if ($id) {
            ...
            $estoque_minimo = !empty($_POST['produto_estoque_minimo']) ? (float)$_POST['produto_estoque_minimo'] : null;
            $estoque_maximo = !empty($_POST['produto_estoque_maximo']) ? (float)$_POST['produto_estoque_maximo'] : null;
            $preco_custo = !empty($_POST['produto_preco_custo']) ? (float)$_POST['produto_preco_custo'] : null;
            $preco_venda = !empty($_POST['produto_preco_venda']) ? (float)$_POST['produto_preco_venda'] : null;
