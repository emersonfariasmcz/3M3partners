...
// === CORRECAO: Removida a verificacao problematica de $categorias ===
// A verificacao foi movida para o controller, que garante que $categorias
// sera passada. A verificacao aqui estava causando redirecionamento inesperado.
// =====================================================================
?>
                        ...
                        <form action="/iga/app/controllers/produto_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="produto_unidade_medida" name="produto_unidade_medida" value="UN" required maxlength="20">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_estoque_minimo" name="produto_estoque_minimo" min="0" value="0">
                                    <div class="form-text">Opcional</div>
                                </div>
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_estoque_maximo" name="produto_estoque_maximo" min="0" value="0">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_preco_custo" name="produto_preco_custo" min="0" step="0.01" value="0.00">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_preco_venda" name="produto_preco_venda" min="0" step="0.01" value="0.00">
                                    <div class="form-text">Opcional</div>
                                </div>
