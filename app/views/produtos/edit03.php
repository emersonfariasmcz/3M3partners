...
if (!isset($produto) || !isset($categorias)) {
     error_log("View edit.php: Variáveis \$produto ou \$categorias não definidas. Redirecionando para controller.");
...
<body>
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10"> <!-- Ajustado para melhor visualização -->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="produto_unidade_medida" name="produto_unidade_medida"
                                        value="<?= htmlspecialchars($produto['produto_unidade_medida'] ?? 'UN') ?>" required maxlength="20">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_estoque_minimo" name="produto_estoque_minimo"
                                        value="<?= htmlspecialchars($produto['produto_estoque_minimo'] ?? 0) ?>" min="0">
                                    <div class="form-text">Opcional</div>
                                </div>
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_estoque_maximo" name="produto_estoque_maximo"
                                        value="<?= htmlspecialchars($produto['produto_estoque_maximo'] ?? 0) ?>" min="0">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_preco_custo" name="produto_preco_custo"
                                        value="<?= isset($produto['produto_preco_custo']) ? number_format($produto['produto_preco_custo'], 2, '.', '') : '0.00' ?>" min="0" step="0.01">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="produto_preco_venda" name="produto_preco_venda"
                                        value="<?= isset($produto['produto_preco_venda']) ? number_format($produto['produto_preco_venda'], 2, '.', '') : '0.00' ?>" min="0" step="0.01">
                                    <div class="form-text">Opcional</div>
                                </div>
