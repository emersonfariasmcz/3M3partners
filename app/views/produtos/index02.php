...
// Verificação de papel foi movida para o controller, mas pode ser reforçada aqui se necessário
                            ...
                            <?php if ($total_produtos > 0): ?>
                                <?php foreach ($produtos as $produto): ?>
                                    <tr>
                                        ...
                                        <td>R$ <?= $produto['produto_preco_venda'] !== null ? number_format($produto['produto_preco_venda'], 2, ',', '.') : 'N/A' ?></td>
                                        <td>
