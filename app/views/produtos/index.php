                    ...
                    <table class="table table-hover table-striped mb-0">
                        <thead>
                            <tr>
                                ...
                                <th>Nome</th>
                                <th>Categoria</th>
                                <th>Apresentação</th> <!-- === ALTERAÇÃO: Nome da coluna === -->
                                <th>Estoque Mín.</th>
                                <th>Estoque Máx.</th>
                                <!-- === REMOÇÃO: Coluna "Preço Venda" === -->
                                <th>Status</th>
                            ...
                            <?php if ($total_produtos > 0): ?>
                                <?php foreach ($produtos as $produto): ?>
                                    <tr>
                                        ...
                                        <!-- === ALTERAÇÃO: Mostrar nome/sigla da unidade de medida === -->
                                        <td><?= htmlspecialchars($produto['unidademedida_sigla'] ?? $produto['unidademedida_nome'] ?? 'N/A') ?></td>
                                        <!-- ======================================================== -->
                                        <td><?= $produto['produto_estoque_minimo'] !== null ? htmlspecialchars($produto['produto_estoque_minimo']) : 'N/A' ?></td>
                                        <td><?= $produto['produto_estoque_maximo'] !== null ? htmlspecialchars($produto['produto_estoque_maximo']) : 'N/A' ?></td>
                                        <!-- === REMOÇÃO: Coluna "Preço Venda" === -->
                                        <td>
