...
// Verificação adicionada para evitar erro caso $categorias não seja definida
if (!isset($categorias)) {
    $_SESSION['erro_salvar'] = "Erro ao carregar categorias.";
                        ...
                        <form action="/iga/app/controllers/produto_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="produto_unidade_medida" name="produto_unidade_medida" required maxlength="20">
