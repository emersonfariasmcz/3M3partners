<?php
# ========================================
# Formulário de Criação de Distrito
# Local: /app/views/distritos/create.php
# ========================================
...
<head>
    ...
    <title>Novo Distrito - Sistema IGA</title>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-map-marker-alt me-2"></i>Novo Distrito
                        </h4>
                    </div>
                        ...
                        <form action="../../app/controllers/distrito_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="distrito_nome" name="distrito_nome" required maxlength="100">
