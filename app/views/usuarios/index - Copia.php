...
if (!isset($usuarios)) {
    ...
    // Isso garante que a página sempre seja acessada avec les données.
  ...
  <div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="d-flex gap-2">
        ...
        <a href="../../app/views/usuarios/create.php" class="btn btn-custom-add">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                          <a href="../../app/controllers/usuario_controller.php?acao=editar&id=<?= htmlspecialchars($usuario['usuario_id']) ?>" class="btn btn-custom-edit btn-sm" title="Editar usuário">
