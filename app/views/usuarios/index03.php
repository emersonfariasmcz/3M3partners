...
if (!isset($usuarios)) {
    ...
    // Isso garante que a página sempre seja acessada com os dados.
...
<head>
  ...
  <style>
    /* Estilos personalizados para o visual da tabela */
    .btn-custom-add {
...
<body>
  <div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div>
        <a href="/iga/app/views/dashboard.php" class="btn btn-custom-back me-2">
