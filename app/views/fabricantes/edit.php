<?php
# ========================================
# Formulário de Edição de Fabricante
# Local: /app/views/fabricantes/edit.php
# ========================================
...
<head>
    ...
    <title>Editar Fabricante - Sistema IGA</title>
            ...
            <div class="col-lg-10">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-edit me-2"></i>Editar Fabricante
                        </h4>
                    </div>
                        ...
                        <form action="/iga/app/controllers/fabricante_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="fabricante_nome" name="fabricante_nome"
                                        value="<?= htmlspecialchars($fabricante['fabricante_nome'] ?? '') ?>" required maxlength="100">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control cnpj-input" id="fabricante_cnpj" name="fabricante_cnpj"
                                        value="<?= !empty($fabricante['fabricante_cnpj']) ? htmlspecialchars($fabricante['fabricante_cnpj']) : '' ?>" maxlength="18">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control telefone-input" id="fabricante_telefone" name="fabricante_telefone"
                                        value="<?= htmlspecialchars($fabricante['fabricante_telefone'] ?? '') ?>" maxlength="20">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="fabricante_email" name="fabricante_email"
                                        value="<?= htmlspecialchars($fabricante['fabricante_email'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="fabricante_endereco" name="fabricante_endereco"
                                        value="<?= htmlspecialchars($fabricante['fabricante_endereco'] ?? '') ?>" maxlength="255">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="fabricante_cidade" name="fabricante_cidade"
                                        value="<?= htmlspecialchars($fabricante['fabricante_cidade'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="fabricante_estado" name="fabricante_estado"
                                        value="<?= htmlspecialchars($fabricante['fabricante_estado'] ?? '') ?>" maxlength="50">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control cep-input" id="fabricante_cep" name="fabricante_cep"
                                        value="<?= htmlspecialchars($fabricante['fabricante_cep'] ?? '') ?>" maxlength="10">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" id="fabricante_status" name="fabricante_status" required>
                                        <option value="ativo" <?= (isset($fabricante['fabricante_status']) && $fabricante['fabricante_status'] == 'ativo') ? 'selected' : '' ?>>Ativo</option>
                                        <option value="inativo" <?= (isset($fabricante['fabricante_status']) && $fabricante['fabricante_status'] == 'inativo') ? 'selected' : '' ?>>Inativo</option>
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="fabricante_observacoes" name="fabricante_observacoes" rows="3" maxlength="500"><?= htmlspecialchars($fabricante['fabricante_observacoes'] ?? '') ?></textarea>
