...
<head>
  ...
  <title>Dashboard - Sistema 3M3 Partners</title> <!-- Nome atualizado -->

  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"> <!-- Corrigido: Removido espaço extra -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"> <!-- Corrigido: Removido espaço extra -->
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="../../assets/img/img_logo.png" alt="Logo 3M3 Partners" style="width: 140px;"> <!-- Nome atualizado -->
      </a>
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="menuCadastros" role="button" data-bs-toggle="dropdown">
              <i class="fas fa-database"></i> Cadastros <!-- Nome atualizado -->
            </a>
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="../../app/controllers/unidade_controller.php?acao=listar"><i class="fas fa-hospital"></i> Unidades de Saúde</a></li>
              ...
              <li><a class="dropdown-item" href="../../app/controllers/supervisor_controller.php?acao=listar"><i class="fas fa-user-tie"></i> Supervisores</a></li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="menuMov" role="button" data-bs-toggle="dropdown">
              <i class="fas fa-exchange-alt"></i> Movimentações <!-- Nome atualizado -->
            </a>
            <ul class="dropdown-menu">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="../../app/controllers/relatorio_controller.php?tipo=unidades"><i class="fas fa-clinic-medical"></i> Unidades de Saúde</a></li>
              ...
              <li><a class="dropdown-item" href="../../app/controllers/relatorio_controller.php?tipo=supervisores"><i class="fas fa-user-tie"></i> Supervisores</a></li>
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-md-3">
        <div class="card text-white" style="background-color: #cbd9d3;"> <!-- Cinza Claro -->
          <div class="card-body">
            <h5 class="card-title text-dark">Saídas (mês)</h5> <!-- Texto escuro para contraste -->
            <p class="card-text text-dark fs-4">28</p> <!-- Texto escuro para contraste -->
          </div>
        </div>
      </div>
    </div>
...
<tr>
  ...
  <footer class="text-center mt-5 py-4 border-top">
    <strong>&copy; <?= date('Y'); ?> | 3M3 Partners - Todos Direitos Reservados</strong> <!-- Nome atualizado -->
  </footer>

  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script> <!-- Corrigido: Removido espaço extra -->
</body>
</html>