<?php
# ========================================
# Formulário de Criação de Supervisor
# Local: /app/views/supervisores/create.php
# ========================================
...
<head>
    ...
    <title>Novo Supervisor - Sistema IGA</title>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-user-tie me-2"></i>Novo Supervisor
                        </h4>
                    </div>
                        ...
                        <form action="/iga/app/controllers/supervisor_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="supervisor_nome" name="supervisor_nome" required maxlength="150">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="supervisor_email" name="supervisor_email" maxlength="100">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control telefone-input" id="supervisor_telefone" name="supervisor_telefone" maxlength="15">
                                    <div class="form-text">Opcional</div>
                                </div>
                            </div> <!-- Fim row -->
