                            ...
                            <?php if ($total_categorias > 0): ?>
                                <?php foreach ($categorias as $categoria): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($categoria['categoria_descricao'] ?? 'N/A') ?></td>
                                        <td>
                                            <span class="badge bg-<?= $categoria['categoria_status'] === 'ativo' ? 'success' : 'secondary' ?>">
                                                <?= htmlspecialchars($categoria['categoria_status']) ?>
                                            </span>
                                        </td>
                                        <td><?= date('d/m/Y H:i', strtotime($categoria['categoria_criadoem'])) ?></td>
