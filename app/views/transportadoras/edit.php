...
# Local: /app/views/transportadoras/edit.php
# ========================================
...
<head>
    ...
    <title>Editar Transportadora - Sistema IGA</title>
                        ...
                        <form action="/3m3erp/app/controllers/transportadora_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="transportadora_nome" name="transportadora_nome"
                                        value="<?= htmlspecialchars($transportadora['transportadora_nome'] ?? '') ?>" required maxlength="120">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control cnpj-input" id="transportadora_cnpj" name="transportadora_cnpj"
                                        value="<?= !empty($transportadora['transportadora_cnpj']) ? htmlspecialchars($transportadora['transportadora_cnpj']) : '' ?>" maxlength="18">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control telefone-input" id="transportadora_telefone" name="transportadora_telefone"
                                        value="<?= htmlspecialchars($transportadora['transportadora_telefone'] ?? '') ?>" maxlength="20">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" id="transportadora_email" name="transportadora_email"
                                        value="<?= htmlspecialchars($transportadora['transportadora_email'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="transportadora_endereco" name="transportadora_endereco"
                                        value="<?= htmlspecialchars($transportadora['transportadora_endereco'] ?? '') ?>" maxlength="200">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="transportadora_bairro" name="transportadora_bairro"
                                        value="<?= htmlspecialchars($transportadora['transportadora_bairro'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="transportadora_cidade" name="transportadora_cidade"
                                        value="<?= htmlspecialchars($transportadora['transportadora_cidade'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="transportadora_estado" name="transportadora_estado"
                                        value="<?= htmlspecialchars($transportadora['transportadora_estado'] ?? '') ?>" maxlength="2">
                                    <div class="form-text">Opcional</div>
                                </div>
