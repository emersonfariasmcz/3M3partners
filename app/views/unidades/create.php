<?php
# ========================================
# Formulário de Criação de Unidade de Saúde
# Local: /app/views/unidades/create.php
# ========================================
...
if (!isset($estados) || !isset($distritos) || !isset($supervisores)) {
    error_log("Acesso direto ao create.php de unidades detectado ou dados necessarios ausentes.");
...
<head>
    ...
    <title>Nova Unidade de Saúde - Sistema IGA</title>
            ...
            <div class="col-lg-12"> <!-- Aumentado para acomodar mais campos -->
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-hospital me-2"></i>Nova Unidade de Saúde
                        </h4>
                    </div>
                        ...
                        <form action="/iga/app/controllers/unidade_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="unidadedesaude_nomecomp" name="unidadedesaude_nomecomp" required maxlength="280">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="unidadedesaude_nomeabrev" name="unidadedesaude_nomeabrev" required maxlength="150">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="unidadedesaude_endereco" name="unidadedesaude_endereco" maxlength="200">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="unidadedesaude_bairro" name="unidadedesaude_bairro" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="unidadedesaude_cidade" name="unidadedesaude_cidade" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="unidadedesaude_direcaoadm" name="unidadedesaude_direcaoadm" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
