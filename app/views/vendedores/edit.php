...
# Local: /app/views/vendedores/edit.php
# ========================================
...
if (!isset($vendedor) || !isset($estados) || !isset($vendedores)) {
    error_log("Acesso direto ao edit.php de vendedores detectado ou dados necessarios ausentes.");
    $_SESSION['erro_salvar'] = "Vendedor ou dados necessários não encontrados.";
...
<head>
    ...
    <title>Editar Vendedor - Sistema IGA</title>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="../../app/controllers/vendedor_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <!-- ID oculto -->
                            <input type="hidden" name="vendedor_id" value="<?= htmlspecialchars($vendedor['vendedor_id']) ?>">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="vendedor_nome" name="vendedor_nome"
                                        value="<?= htmlspecialchars($vendedor['vendedor_nome'] ?? '') ?>" required maxlength="150">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="vendedor_matricula" name="vendedor_matricula"
                                        value="<?= htmlspecialchars($vendedor['vendedor_matricula'] ?? '') ?>" maxlength="20">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control cpf-input" id="vendedor_cpf" name="vendedor_cpf"
                                        value="<?= !empty($vendedor['vendedor_cpf']) ? htmlspecialchars($vendedor['vendedor_cpf']) : '' ?>" maxlength="14">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control telefone-input" id="vendedor_telefone" name="vendedor_telefone"
                                        value="<?= htmlspecialchars($vendedor['vendedor_telefone'] ?? '') ?>" maxlength="20">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" id="vendedor_email" name="vendedor_email"
                                        value="<?= htmlspecialchars($vendedor['vendedor_email'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="vendedor_endereco" name="vendedor_endereco"
                                        value="<?= htmlspecialchars($vendedor['vendedor_endereco'] ?? '') ?>" maxlength="255">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="vendedor_bairro" name="vendedor_bairro"
                                        value="<?= htmlspecialchars($vendedor['vendedor_bairro'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="vendedor_cidade" name="vendedor_cidade"
                                        value="<?= htmlspecialchars($vendedor['vendedor_cidade'] ?? '') ?>" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                    ...
                                    <select class="form-select" id="vendedor_estado_id" name="vendedor_estado_id">
                                        ...
                                        <?php foreach ($estados as $estado): ?>
                                            <option value="<?= htmlspecialchars($estado['estado_id']) ?>"
                                                <?= (isset($vendedor['vendedor_estado_id']) && $estado['estado_id'] == $vendedor['vendedor_estado_id']) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control cep-input" id="vendedor_cep" name="vendedor_cep"
                                        value="<?= htmlspecialchars($vendedor['vendedor_cep'] ?? '') ?>" maxlength="10">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="vendedor_comissao_percentual" name="vendedor_comissao_percentual"
                                        value="<?= $vendedor['vendedor_comissao_percentual'] !== null ? number_format($vendedor['vendedor_comissao_percentual'], 2, '.', '') : '0.00' ?>" min="0" max="100" step="0.01">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="vendedor_data_admissao" name="vendedor_data_admissao"
                                        value="<?= !empty($vendedor['vendedor_data_admissao']) ? date('Y-m-d', strtotime($vendedor['vendedor_data_admissao'])) : '' ?>">
                                    <div class="form-text">Opcional</div>
                                </div>
                                    ...
                                    <select class="form-select" id="vendedor_supervisor_id" name="vendedor_supervisor_id">
                                        ...
                                        <?php foreach ($vendedores as $supervisor): ?>
                                            <option value="<?= htmlspecialchars($supervisor['vendedor_id']) ?>"
                                                <?= (isset($vendedor['vendedor_supervisor_id']) && $supervisor['vendedor_id'] == $vendedor['vendedor_supervisor_id']) ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="vendedor_status" name="vendedor_status" required>
                                        <option value="ativo" <?= (isset($vendedor['vendedor_status']) && $vendedor['vendedor_status'] == 'ativo') ? 'selected' : '' ?>>Ativo</option>
                                        <option value="inativo" <?= (isset($vendedor['vendedor_status']) && $vendedor['vendedor_status'] == 'inativo') ? 'selected' : '' ?>>Inativo</option>
                                    </select>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="vendedor_observacoes" name="vendedor_observacoes" rows="3" maxlength="500"><?= htmlspecialchars($vendedor['vendedor_observacoes'] ?? '') ?></textarea>
