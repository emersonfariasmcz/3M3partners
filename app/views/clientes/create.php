...
# Local: /app/views/clientes/create.php
# ========================================
...
<head>
    ...
    <title>Novo Cliente - Sistema IGA</title>
            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-user-tie me-2"></i>Novo Cliente
                        </h4>
                    </div>
                        ...
                        <form action="/iga/app/controllers/cliente_controller.php?acao=salvar" method="POST" class="needs-validation" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="cliente_nome" name="cliente_nome" required maxlength="150">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="cliente_nome_fantasia" name="cliente_nome_fantasia" maxlength="100">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control cpf-cnpj-input" id="cliente_cnpj_cpf" name="cliente_cnpj_cpf" maxlength="18">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="cliente_inscricao_estadual" name="cliente_inscricao_estadual" maxlength="20">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="cliente_endereco" name="cliente_endereco" maxlength="255">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="cliente_bairro" name="cliente_bairro" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="cliente_cidade" name="cliente_cidade" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control cep-input" id="cliente_cep" name="cliente_cep" maxlength="10">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control telefone-input" id="cliente_telefone" name="cliente_telefone" maxlength="20">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control telefone-input" id="cliente_telefone_secundario" name="cliente_telefone_secundario" maxlength="20">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="cliente_email" name="cliente_email" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="cliente_contato_principal" name="cliente_contato_principal" maxlength="100">
                                    <div class="form-text">Opcional</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="cliente_observacoes" name="cliente_observacoes" rows="3" maxlength="500"></textarea>
