  ...
  <div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="d-flex gap-2">
        ...
        <a href="/iga/app/views/usuarios/create.php" class="btn btn-custom-add">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                          <a href="/iga/app/controllers/usuario_controller.php?acao=editar&id=<?= htmlspecialchars($usuario['usuario_id']) ?>" class="btn btn-custom-edit btn-sm" title="Editar usuário">
                            <i class="fas fa-edit"></i>
                          </a>
                          <form action="/iga/app/controllers/usuario_controller.php?acao=excluir" method="POST" class="d-inline" onsubmit="return confirm('Deseja realmente excluir este usuário?');">
                              <input type="hidden" name="usuario_id" value="<?= htmlspecialchars($usuario['usuario_id']) ?>">
                              <button type="submit" class="btn btn-custom-delete btn-sm" title="Excluir usuário">
