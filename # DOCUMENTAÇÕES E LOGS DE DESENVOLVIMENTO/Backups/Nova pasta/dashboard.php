      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="/iga/app/controllers/configuracao_controller.php?acao=geral">Gerais</a></li>
              <li><a class="dropdown-item" href="/iga/app/controllers/configuracao_controller.php?acao=niveis">Níveis de Usuário</a></li>
            </ul>
          </li>
        </ul>
